...
export default function Account() {
  ...
  return (
    <section>
      <div className="mx-auto bg-[F2ECBE] px-4 sm:px-6 lg:px-8 text-gray-900">
        <div className=" bg-transparent shadow-xl">
          <div className="p-6 sm:p-12">
            ...
            <button
              ...
              className="mt-5  inline-block bg-[#C08261] text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
            >
              View Your Orders
            </button>
            <div className="mt-6">
                    ...
                    addresses.map((item) => (
                      <div className="border p-6" key={item._id}>
                        ...
                        <button
                          ...
                          className="mt-5 mr-5 inline-block bg-[#C08261] text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          Update
                        </button>
                        <button
                ...
                <div className="w-full mt-6 mr-0 mb-0 ml-0 space-y-8">
                  {addNewAddressFormControls.map((controlItem) => (
                    <InputComponent
                      ...
                      value={addressFormData[controlItem._id]}
                      onChange={(event) =>
                        setAddressFormData({
                          ...addressFormData,
