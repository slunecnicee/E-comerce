...
import { getAllOrdersForAllUsers, updateStatusOfOrder } from "@/servises/order";
              ...
              {allOrdersForAllUsers && allOrdersForAllUsers.length ? (
                <ul className="flex  flex-col-reverse gap-4">
                  {allOrdersForAllUsers.map((item) => (
                    <li
                      key={item._id}
                      className="bg-[#C08261] shadow p-5 flex flex-col space-y-3 py-6 text-left"
                    >
                      <div className="flex">
                      ...
                      <div className="flex gap-5">
                        <button className="disabled:opacity-50 mt-5 mr-5  inline-block bg-[#F2ECBE] text-yellow-900 px-5 py-3 text-xs font-bold uppercase tracking-wide">
                          {item.isProcessing
                            ? "Order is Processing"
                            : "Order is delivered"}
                        </button>
                        <button
                          ...
                          className="disabled:opacity-50 mt-5 mr-5  inline-block bg-[#F2ECBE] text-yellow-900 px-5 py-3 text-xs font-bold uppercase tracking-wide"
                        >
                          {componentLevelLoader &&
