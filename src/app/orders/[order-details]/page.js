...
import { getOrderDetails } from "@/servises/order";
    ...
    <div className="py-14 px-4 md:px-6">
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="flex flex-col justify-start items-start bg-transparent shadow-2xl px-4 py-4 md:p-6 xl:p-8 w-full">
          ...
          <div className="flex justify-center flex-col md:flex-row items-stretch w-full space-y-4 md:space-y-0 md:space-x-5 xl:space-x-8">
            <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-transparent shadow-2xl space-y-6">
              <h3 className="text-xl font-semibold leading-6 text-gray-900">
                Summary
              </h3>
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-transparent shadow-2xl w-full xl:w-96 flex  items-center md:items-start px-4 py-6 flex-col">
            <h3 className="text-xl font-semibold leading-6 text-gray-900">
              Customer Details
            </h3>
          ...
          <button
            onClick={() => router.push(`/`)}
            className="mt-5 mr-5  inline-block bg-[#9A3B3B] text-yellow-400 px-5 py-3 text-xs font-bold uppercase tracking-wide"
          >
            Shop Again
          </button>
        </div>
