              ...
              <div className="mt-6 border-t border-b py-2">
                ...
                <div className="mt-5 text-center">
                  <button
                    ...
                    className="disabled:opacity-50 group inline-flex w-full items-center justify-center bg-[#602424] px-6 py-4 text-lg text-white font-medium uppercase tracking-wide"
                  >
                    Checkout
                  </button>
                </div>
