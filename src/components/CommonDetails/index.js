          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
              ...
              <button
                ...
                className="mt-1.5 inline-block bg-[#895d46] text-yellow-400 px-5 py-3 text-xs font-bold tracking-wide uppercase "
              >
            ...
            <ul className="mt-8 space-y-2">
              ...
              <li className="flex items-center text-left text-sm font-semibold text-gray-700">
                <span className="text-lg font-bold mr-2">Available sizes:</span>
